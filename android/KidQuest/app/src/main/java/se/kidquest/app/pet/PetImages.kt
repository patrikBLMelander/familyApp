...
object PetImages {
    ...
    private val EGG_TO_PET = mapOf(
        ...
        "ember_egg" to "scorpion",
        "indigo_egg" to "octopus",
        "frost_egg" to "snowleopard",
        "tiger_egg" to "tiger",
        "snow_egg" to "polarbear",
        "savanna_egg" to "giraffe",
        "ivory_egg" to "elephant",
        "swamp_egg" to "crocodile",
        "onyx_egg" to "panther",
        "moon_egg" to "wolf",
    )
